...
namespace scr
{
	...
	public:
		...
		inline const std::shared_ptr<Mesh> GetMesh(avs::uid uid) const { return m_Meshes.at(uid); }
		inline const std::shared_ptr<Material> GetMaterial(avs::uid uid) const { return m_Materials.at(uid); }
		inline const std::shared_ptr<Transform> GetTransform(avs::uid uid) const { return m_Transforms.at(uid); }
