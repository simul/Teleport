...
void Camera::UpdateProjection(float left, float right, float bottom, float top, float near_, float far_)
{
	...
	m_CameraData.m_ProjectionMatrix = mat4::Orthographic(left, right, bottom, top, near_, far_);
}