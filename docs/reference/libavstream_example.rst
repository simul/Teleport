...
.. code-block:: cpp
   :caption: How to create and configure an avs::Queue.
...
.. code-block:: cpp
   :caption: How to create a video encoding pipeline in a wrapper class.
...
.. code-block:: cpp
   :caption: How to create a network transfer pipeline in a wrapper class.
