...
// OvrAnimComponent::OvrAnimComponent
OvrAnimComponent::OvrAnimComponent()
	: OvrAnimComponent( 30.0f, true )
{
}

//================================
// OvrAnimComponent::Frame
eMsgStatus OvrAnimComponent::Frame( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame,
	VRMenuObject * self, VRMenuEvent const & event ) 
{
	// only recalculate the current frame if playing
	if ( AnimState == ANIMSTATE_PLAYING )
	{
		double timePassed = vrapi_GetTimeInSeconds() - BaseTime;
...
void OvrAnimComponent::SetFrame( VRMenuObject * self, int const frameNum )
{
	...
	BaseFrame = frameNum;
	BaseTime = vrapi_GetTimeInSeconds();
...
eMsgStatus OvrAnimComponent::OnEvent_Impl( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame,
		VRMenuObject * self, VRMenuEvent const & event )
{
...
// OvrSurfaceAnimComponent::OvrSurfaceAnimComponent
OvrSurfaceAnimComponent::OvrSurfaceAnimComponent()
	: OvrSurfaceAnimComponent( 30.0f, true, 1 )
{
}

//================================
// OvrSurfaceAnimComponent::SetFrameVisibilities
void OvrSurfaceAnimComponent::SetFrameVisibilities( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame, VRMenuObject * self ) const
{
...
void OvrTrailsAnimComponent::SetFrameVisibilities( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame, VRMenuObject * self ) const
{
