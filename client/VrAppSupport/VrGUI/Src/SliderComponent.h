...
public:
	...
	static void			GetVerticalSliderParms( VRMenu & menu, 
...
private:
	...
	float			LastDot;			// last dot product deduced from touch... used to apply the movement on a touch up
...
private:
	...
	eMsgStatus			OnFrameUpdate( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchDown( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchUp( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchRelative( OvrGuiSys & guiSys, ovrFrameInput const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
