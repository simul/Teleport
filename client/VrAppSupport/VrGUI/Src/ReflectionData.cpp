...
{
	static_cast< eSurfaceTextureType* >( objPtr )[index] = *static_cast< eSurfaceTextureType* >( elementPtr );
}
...
ovrMemberInfo VRMenuSurfaceParms_Reflection[] =
{
	...
	{ "TextureTypes",	"eSurfaceTextureType[]",		NULL, ovrTypeOperator::ARRAY,	offsetof( VRMenuSurfaceParms, TextureTypes ),	VRMENUSURFACE_IMAGE_MAX },	
	{ "Contents",		"BitFlagsT< eContentFlags >",	NULL, ovrTypeOperator::NONE,	offsetof( VRMenuSurfaceParms, Contents ),		0 },
	...
	{ "OffsetUVs",		"Vector2f",						NULL, ovrTypeOperator::NONE,	offsetof( VRMenuSurfaceParms, OffsetUVs ),		0 },
	{ }
};

ovrMemberInfo VRMenuFontParms_Reflection[] =
{
	{ "AlignHoriz",		"HorizontalJustification",	NULL, ovrTypeOperator::NONE, offsetof( VRMenuFontParms, AlignHoriz ), 0 },	
	{ "AlignVert",		"VerticalJustification",	NULL, ovrTypeOperator::NONE, offsetof( VRMenuFontParms, AlignVert ), 0 },
...
ovrMemberInfo VRMenuObjectParms_Reflection[] =
{
	...
	{ "TextLocalScale",	"Vector3f",								NULL, ovrTypeOperator::NONE,	offsetof( VRMenuObjectParms, TextLocalScale ), 0 },
	{ "FontParms",		"VRMenuFontParms",						NULL, ovrTypeOperator::NONE,	offsetof( VRMenuObjectParms, FontParms ), 0 },
	{ "Color",			"Vector4f",								NULL, ovrTypeOperator::NONE,	offsetof( VRMenuObjectParms, Color ), 0 },
	{ "TextColor",		"Vector4f",								NULL, ovrTypeOperator::NONE,	offsetof( VRMenuObjectParms, TextColor ), 0 },
...
{
	{ "LastPlayTime",	"double",	NULL, ovrTypeOperator::NONE, offsetof( ovrSoundLimiter, LastPlayTime ) },
	{ }
};
...
{
	{ "GazeOverSoundLimiter",	"ovrSoundLimiter",	NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, GazeOverSoundLimiter ) },
	{ "DownSoundLimiter",		"ovrSoundLimiter",	NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, DownSoundLimiter ) },
	{ "UpSoundLimiter",			"ovrSoundLimiter",	NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, UpSoundLimiter ) },
	{ "HilightFader",			"SineFader",		NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, HilightFader ) },
	{ "StartFadeInTime",		"double",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, StartFadeInTime ) },
	{ "StartFadeOutTime",		"double",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, StartFadeOutTime ) },
	{ "HilightOffset",			"Vector3f",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, HilightOffset ) },
	{ "HilightScale",			"float",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, HilightScale ) },
	{ "FadeDuration",			"float",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, FadeDuration ) },
	{ "FadeDelay",				"float",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, FadeDelay ) },
	{ "TextNormalColor",		"Vector4f",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, TextNormalColor ) },
	{ "TextHilightColor",		"Vector4f",			NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, TextHilightColor ) },
	{ "SuppressText",			"bool",				NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, SuppressText ) },
	{ "UseSurfaceAnimator",		"bool",				NULL, ovrTypeOperator::NONE, offsetof( OvrDefaultComponent, UseSurfaceAnimator ) },
...
ovrMemberInfo OvrAnimComponent_Reflection[] =
{
	...
	{ "FramesPerSecond",		"float",						NULL,	ovrTypeOperator::NONE,	offsetof( OvrAnimComponent, FramesPerSecond ) },
	{ "AnimState",				"OvrAnimComponent::eAnimState",	NULL,	ovrTypeOperator::NONE,	offsetof( OvrAnimComponent, AnimState ) },
	{ "Looping",				"bool",							NULL,	ovrTypeOperator::NONE,	offsetof( OvrAnimComponent, Looping ) },
	{ "ForceVisibilityUpdate",	"bool",							NULL,	ovrTypeOperator::NONE,	offsetof( OvrAnimComponent, ForceVisibilityUpdate ) },
	{ "FractionalFrame",		"float",						NULL,	ovrTypeOperator::NONE,	offsetof( OvrAnimComponent, FractionalFrame ) },
...
{
	{ "SurfacesPerFrame",		"int",			NULL,	ovrTypeOperator::NONE,	offsetof( OvrSurfaceAnimComponent, SurfacesPerFrame ) },
	{ }
};

ovrTypeInfo TypeInfoList[] =
{
	{ "bool",	NULL, sizeof( bool ),	NULL, ParseBool,	Create_bool,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "float",	NULL, sizeof( float ),	NULL, ParseFloat,	Create_float,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "double",	NULL, sizeof( double ),	NULL, ParseDouble,	Create_double,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "int",	NULL, sizeof( int ),	NULL, ParseInt,		Create_int,		NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "GLuint",	NULL, sizeof( GLuint ),	NULL, ParseInt,		Create_int,		NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	
	{ "eVRMenuObjectType",						NULL, sizeof( eVRMenuObjectType ),				VRMenuObjectType_Enums,			ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "eVRMenuObjectFlags",						NULL, sizeof( eVRMenuObjectFlags ),				VRMenuObjectFlag_Enums,			ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "eVRMenuObjectInitFlags",					NULL, sizeof( eVRMenuObjectInitFlags ),			VRMenuObjectInitFlag_Enums,		ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "eVRMenuId",								NULL, sizeof( eVRMenuId ),						VRMenuId_Enums,					ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "eSurfaceTextureType",					NULL, sizeof( eSurfaceTextureType ),			SurfaceTextureType_Enums,		ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "HorizontalJustification",				NULL, sizeof( HorizontalJustification ),		HorizontalJustification_Enums,	ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "VerticalJustification",					NULL, sizeof( VerticalJustification ),			VerticalJustification_Enums,	ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "eContentFlags",							NULL, sizeof( eContentFlags ),					eContentFlags_Enums,			ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "eVRMenuEventType",						NULL, sizeof( eVRMenuEventType ),				VRMenuEventType_Enums,			ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },
	{ "OvrAnimComponent::eAnimState",			NULL, sizeof( OvrAnimComponent::eAnimState ),	AnimState_Enums,				ParseEnum,		Create_int,	NULL,	NULL,	ovrArrayType::NONE,	false, NULL },

	{ "BitFlagsT< eVRMenuObjectFlags >",		NULL, sizeof( BitFlagsT< eVRMenuObjectFlags > ),			VRMenuObjectFlag_Enums,			ParseBitFlags,	NULL,	NULL,	NULL,	ovrArrayType::NONE,	false,	NULL },
	{ "BitFlagsT< eVRMenuObjectInitFlags >",	NULL, sizeof( BitFlagsT< eVRMenuObjectInitFlags > ),		VRMenuObjectInitFlag_Enums,		ParseBitFlags,	NULL,	NULL,	NULL,	ovrArrayType::NONE,	false,	NULL },
	...
	{ "Vector4f",		NULL,	sizeof( Vector4f ),		NULL, ParseFloatVector,	NULL,				NULL,	NULL,	ovrArrayType::NONE,	false,	Vector4f_Reflection },
	{ "Quatf",			NULL,	sizeof( Quatf ),		NULL, ParseFloatVector,	NULL,				NULL,	NULL,	ovrArrayType::NONE,	false,	Quatf_Reflection },
	{ "Posef",			NULL,	sizeof( Posef ),		NULL, NULL,				NULL,				NULL,	NULL,	ovrArrayType::NONE,	false,	Posef_Reflection },
	...
	{ "VRMenuSurfaceParms",		NULL,	sizeof( VRMenuSurfaceParms ),	NULL, NULL,	Create_VRMenuSurfaceParms,	NULL,	NULL,	ovrArrayType::NONE,	false, VRMenuSurfaceParms_Reflection },
	{ "VRMenuFontParms",		NULL,	sizeof( VRMenuFontParms ),		NULL, NULL,	NULL,						NULL,	NULL,	ovrArrayType::NONE,	false, VRMenuFontParms_Reflection },
	{ "VRMenuObjectParms",		NULL,	sizeof( VRMenuObjectParms ),	NULL, NULL,	Create_VRMenuObjectParms,	NULL,	NULL,	ovrArrayType::NONE,	false, VRMenuObjectParms_Reflection },

	{ "Fader",								NULL,						sizeof( Fader ),								NULL, NULL,	NULL,									NULL,	NULL,	ovrArrayType::NONE,	false,			Fader_Reflection }, 
	{ "SineFader",							"Fader",					sizeof( SineFader ),							NULL, NULL,	NULL,									NULL,	NULL,	ovrArrayType::NONE,	false,			SineFader_Reflection }, 
	{ "ovrSoundLimiter",					NULL,						sizeof( ovrSoundLimiter ),						NULL, NULL,	Create_ovrSoundLimiter,					NULL,	NULL,	ovrArrayType::NONE,	false,			ovrSoundLimiter_Reflection }, 
	{ "VRMenuComponent",					NULL,						sizeof( VRMenuComponent),						NULL, NULL,	NULL,									NULL,	NULL,	ovrArrayType::NONE,	true,			VRMenuComponent_Reflection }, 
	{ "OvrDefaultComponent",				"VRMenuComponent",			sizeof( OvrDefaultComponent ),					NULL, NULL,	Create_OvrDefaultComponent,				NULL,	NULL,	ovrArrayType::NONE,	false,			OvrDefaultComponent_Reflection }, 
	{ "OvrAnimComponent",					"VRMenuComponent",			sizeof( OvrAnimComponent ),						NULL, NULL,	NULL,									NULL,	NULL,	ovrArrayType::NONE,	true,			OvrAnimComponent_Reflection }, 
	{ "OvrSurfaceAnimComponent",			"OvrAnimComponent",			sizeof( OvrSurfaceAnimComponent ),				NULL, NULL, Create_OvrSurfaceAnimComponent,			NULL,	NULL,	ovrArrayType::NONE,	false,			OvrSurfaceAnimComponent_Reflection }, 
