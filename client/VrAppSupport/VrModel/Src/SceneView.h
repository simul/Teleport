...
#include "ModelFile.h"
#include "App.h"		// ovrFrameResult
#include "OVR_Input.h"	// ovrFrameInput, etc
...
public:
	...
	void					SetFootPos( const Vector3f & pos, bool updateCenterEye = true );

	Vector3f				GetNeutralHeadCenter() const;		// FootPos + EyeHeight
	...
	void					SetYawMod( const float yawMod ) { YawMod = yawMod; }
